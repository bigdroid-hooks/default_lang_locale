...
sed -i 's|ro.product.locale.language=.*|ro.product.locale.language=en|g' "$SYSTEM_DIR/build.prop" && \
sed -i 's|ro.product.locale.region=.*|ro.product.locale.region=US|g' "$SYSTEM_DIR/build.prop" || exit
